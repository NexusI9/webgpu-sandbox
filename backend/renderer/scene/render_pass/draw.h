...
void render_pass_draw_onscreen_multisample(RenderPass *,
                                           const RenderPassDrawOptions *);
void render_pass_draw_offscreen(RenderPass *, const RenderPassDrawOptions *);

void render_pass_draw(RenderPass *, const RenderPassDrawOptions *);

 WGPUCommandEncoder render_pass_command_begin(RenderPass *);
void render_pass_command_draw(RenderPass *, const RenderPassDrawOptions *);
