...
static inline void
shadow_map_draw_spot_light(const ShadowMapDrawSpotLightDescriptor *,
                           const ShadowMapDebug *);
static inline void
shadow_map_draw_sun_light(const ShadowMapDrawSunLightDescriptor *,
                          const ShadowMapDebug *);
static inline void
...
static inline void
shadow_map_draw_point_light(const ShadowMapDrawPointLightDescriptor *,
                            const ShadowMapDebug *);

static inline void shadow_map_draw_all(const ShadowMapDrawAllDescriptor *,
                                       const ShadowMapDebug *);
