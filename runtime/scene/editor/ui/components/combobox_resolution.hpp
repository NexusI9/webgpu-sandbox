#ifndef _SCENE_EDITOR_UI_COMPONENT_COMBOBOX_RESOLUTION_H_
#define _SCENE_EDITOR_UI_COMPONENT_COMBOBOX_RESOLUTION_H_
...
public:
  ComboboxResolution(Scene *scene, const char *label, const char *default_value,
                     const InputStyle *style,
                     const TextureResolution current_resolution,
                     combobox_resolution_on_select on_select_callback)
      : Component(scene, label), current_resolution(current_resolution),
