...
void seo_light_sun_set_position(Mesh *mesh, SceneEditorObject *seo, vec3 value) {
...
void seo_light_sun_set_rotation(Mesh *mesh, SceneEditorObject *seo, vec3 value) {}

void seo_light_sun_set_scale(Mesh *mesxh, SceneEditorObject *seo, vec3 value) {}
...
void seo_light_sun_shadow_set_position(Mesh *mesh, SceneEditorObject *seo,
                                    vec3 value) {
...
static const seo_transform_axis_callback
    light_transform_callback[2][GIZMO_TRANSFORM_MODE_COUNT] = {
        ...
        [LightShadow_Enabled] =
            {
                [GizmoTransformMode_Position] = seo_light_sun_shadow_set_position,
                [GizmoTransformMode_Rotation] = seo_light_sun_set_rotation,
                [GizmoTransformMode_Scale] = seo_light_sun_set_scale,
            },
};
