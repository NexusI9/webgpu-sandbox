...
static inline DynamicListStatus gui_tree_remove_at_index(GUITree *tree,
                                                        size_t index) {
  return dyli_remove_at_index((void *)tree->entries, &tree->count,
