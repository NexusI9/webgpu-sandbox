#ifndef _GUI_STYLE_CARBON_H_
#define _GUI_STYLE_CARBON_H_
...
inline void gui_style_carbon(Gui *gui) {
  ...
  style.Colors[ImGuiCol_Text] =
      (ImVec4 &)*theme_color(gui->theme, ThemeColor_Text_On_Dark);

  style.Colors[ImGuiCol_TextDisabled] =
      (ImVec4 &)*theme_color(gui->theme, ThemeColor_Text_Disabled_On_Dark);

  style.Colors[ImGuiCol_WindowBg] =
      (ImVec4 &)*theme_color(gui->theme, ThemeColor_Surface_Lower);
  ...
  style.Colors[ImGuiCol_FrameBg] =
      (ImVec4 &)*theme_color(gui->theme, ThemeColor_Surface_Lowest);
